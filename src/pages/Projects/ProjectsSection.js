        ...
        <TimelineContainer>
          <VerticalLineWrapper>
            <VerticalLineContent position="left">
              <strong style={{"font-size": "1.5rem"}}>Agile Full Stack Software Development Project </strong>
            ...
            <VerticalLineContent position="left">
              <strong style={{"font-size": "1.5rem"}}>Computer Networks Course Client-Server Application Project</strong>
              <p style={{"font-size": "0.7rem", "fontFamily": "Sans-serif", "color": "grey"}}>October 2022-January 2023</p>
            ...
            <VerticalLineContent position="left">
              <strong style={{"font-size": "1.5rem"}}>Mobile Programming Course Social Media App Term Project </strong>
            ...
            <VerticalLineContent position="left">
              <strong style={{"font-size": "1.5rem"}}>Data Science Course Term Project, Sabancı University 	 </strong>
